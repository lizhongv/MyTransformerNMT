...
parser.add_argument('--layers', default=2, type=int, help='layers of transformers')
parser.add_argument('--h-num', default=8, type=int, help='heads of MultiHeadAttention')
